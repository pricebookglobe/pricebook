...
export const UI_STRINGS = [
  ...
  "Items with the most price-accuracy complaints, first",
  "Nutrition facts",
  "Look up nutrition facts",
  "Estimating…",
  "AI estimate based on similar products — please check against the actual package before relying on it.",
  "Serving size",
  "Calories",
  "Protein (g)",
  "Fat (g)",
  ...
  "1. Get the template",
  "A spreadsheet with the right columns. Open it in Excel, Google Sheets, or Numbers, fill in your items, then save or export as CSV.",
  "Download template (CSV)",
  "2. Upload your file",
  "Required columns: item_name, category, price. Optional: brand, size, unit, currency (defaults to JOD), barcode.",
  "Choose CSV file",
  "Uploading…",
  "Upload and process",
  "items added",
  ...
  "Store API",
  "Connect your own POS or inventory system to automatically update your prices — see the",
  "API documentation",
  "Store ID",
  "Show",
  "Copy",
  "Copied!",
  "Regenerate",
  "Regenerating immediately invalidates the old key — update anything using it right away.",
  "Scan Barcode",
  "Reading barcode…",
